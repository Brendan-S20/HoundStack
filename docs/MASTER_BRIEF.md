...
| MKT-5 | 🟢 Closed | **The ledger was wrong about this, not the site.** `/privacy` and `/terms` carry no draft notice and never did — checked the source and the built HTML. They read as finished documents with "Last updated: July 14, 2026" and full sections, ported from the app's canonical copies. The "draft pending legal review" was a status line here, not text a visitor ever saw. Owner decision, 2026-08-01: publish as they stand and continue formal review after payments begin. Nothing to remove; the entry itself was the error. |
